...
class Mongo(object):
    ...
    def find(self, query_spec, limit):
        return self._coll.find(query_spec).limit(limit)
    ...
    def delete_many(self, query_spec, limit):
        return self._coll.delete_many(query_spec).limit(limit)
